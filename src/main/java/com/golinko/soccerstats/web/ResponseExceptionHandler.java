...
import com.golinko.soccerstats.exceptions.ExceptionResponseMessage;
...
public class ResponseExceptionHandler {
    ...
    @ExceptionHandler(SoccerStatsException.class)
    public ExceptionResponseMessage handleSoccerStatsException(SoccerStatsException e) {
